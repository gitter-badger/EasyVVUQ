...
def test_gauss_fix(tmpdir):
    ...
    uq.primitives.sampling.random_sampler(my_campaign, num_samples=number_of_samples)
    uq.primitives.sampling.add_replicas(my_campaign, replicates=number_of_replicas)
    ...
    ensemble_boot = uq.primitives.analysis.EnsembleBoot(my_campaign)
